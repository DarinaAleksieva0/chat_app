...
if (isset($_SESSION['username'])) {
    ...
    if (
        ...
        #get data from xhr request and store it in a variable
        $message = $_POST['message'];
        $to_id = $_POST['to_id'];

        #getting the logged in user's username from the SESSION
        ...
        if ($res) {
            //check if thats the first conversation between the users
...
?>
            ...
            <p class="rtext align-self-end border 
                    rounded p-2 mb-1">
                <?= $message ?>
